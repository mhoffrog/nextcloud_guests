...
class AppWhitelist {
	...
	const DEFAULT_WHITELIST = 'activity,files_pdfviewer,files_sharing,files_texteditor,files_trashbin,files_versions,files_videoplayer,firstrunwizard,gallery,notifications';
